...
/**
 * Input to allow user to select a level or pad cut, or leave it empty
 * for creating, or updating a review.
 */
@Component({ name: 'pad-cut-input' })
export default class PadCutInput extends Vue {
    @Prop({ default: 0 })
    value!: PadCut | null;
