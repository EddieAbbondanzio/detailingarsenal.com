...
export * from './product-catalog/data-transfer-objects/pad-color';
...
export * from './product-catalog/data-transfer-objects/requests/pad-color-create';
export * from './product-catalog/data-transfer-objects/requests/pad-option-create';
export * from './product-catalog/data-transfer-objects/requests/pad-option-update';
