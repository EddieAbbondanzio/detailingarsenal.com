...
import { VehicleCategoryCreate } from '@/api/settings/data-transfer-objects/vehicle-category-create';
import { VehicleCategoryUpdate } from '@/api/settings/data-transfer-objects/vehicle-category-update';
