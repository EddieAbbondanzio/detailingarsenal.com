import { Client } from '@/api/clients/data-transfer-objects/client';
import { http } from '@/api/core/http';
import { ClientCreate } from '@/api/clients/data-transfer-objects/client-create';
import { ClientUpdate } from '@/api/clients/data-transfer-objects/client-update';
